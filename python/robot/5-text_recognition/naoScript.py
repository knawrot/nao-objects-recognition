...
class RedBallDetectionModule(ALModule):
	...
	def __init__(self, name):
		...
		self.memory.subscribeToEvent("TextDetectedEvent", name, "handleBallDetection")
	...
	def handleBallDetection(self, key, value, message):
		...
		self.tts.say("I see some text!")
		self.memory.subscribeToEvent("TextDetectedEvent", self.name, "handleBallDetection")
